...
var ReadImg = function (_React$Component) {
  ...
  _createClass(ReadImg, [{
    ...
    value: function onchange() {
      ...
      var that = this;
      var file = document.getElementById('_ReactReadImg').files[0];
    ...
    value: function render() {
      ...
      return React.createElement(
        'div',
        { style: style },
        easyShow ? '' : React.createElement('input', { style: _extends({}, showcss, inputStyle), id: '_ReactReadImg', type: 'file', onChange: this.onchange.bind(this), accept: 'image/jpg,image/jpeg,image/png,image/gif' }),
